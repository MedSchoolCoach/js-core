...
test('Test string should not change', () => {
  expect(convertors.keysToSnake('I_am_a_string')).toBe('I_am_a_string')
})

test('Test array should not change', () => {
  expect(convertors.keysToSnake(['test_1', 'test_two', 'test3', 'testFour']))
