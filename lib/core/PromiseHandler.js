 ...
 */
function createPromiseHandler ({ method, path, params = {}, callback = null, transform = d => d }) {
  return new PromiseHandler({ method, path, params, transform, callback, httpClient: this })
}
...
class PromiseHandler {
  ...
  constructor ({ method, path, params, transform, callback, httpClient }) {
    this._httpRequest = new HttpRequest(method, path, params, httpClient)
